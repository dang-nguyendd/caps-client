...
export default function Home() {
    ...
    const [messages, setMessages] = useImmer<{ sender: string; message: string }[]>([]);
                ...
                <div className="min-w-full border rounded lg:grid lg:grid-cols-3 max-h-screen">
                                ...
                                <a
                                    ...
                                    <div className="w-full pb-2">
                                        <div className="flex justify-between">
                                            <span
                                                className="block ml-2 font-semibold text-gray-600">Dengue Portal</span>
                                            <span className="block ml-2 text-sm text-gray-600">Just Now</span>
                                        </div>
                                        <span
                                            className="block ml-2 text-sm text-gray-600">{lastMessage && lastMessage.message}</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div className="hidden lg:col-span-2 lg:block">
                        <div className="w-full">
                            ...
                            {lastMessage && lastMessage.sender !== 'next' &&  <div className='p-1 pl-5 h-10'></div>}
                            {lastMessage && lastMessage.sender === 'next' && <div className='p-1 font-light pl-5 bg-gray-100 h-10'>GPT-based Dengue portal is typing...</div>}
